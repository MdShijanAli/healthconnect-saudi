...
export const Route = createFileRoute("/register")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Register as a doctor or patient on Sehaty Cloud, the Saudi clinic management platform." },
      { property: "og:title", content: "Create your account — Sehaty Cloud" },
      { property: "og:description", content: "Join Sehaty Cloud as a verified doctor or as a patient booking care in minutes." },
        ...
        <div className="rounded-3xl border border-border/60 bg-card p-8 shadow-lg">
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Field id="password" label="Password" type="password" placeholder="At least 8 characters" autoComplete="new-password" minLength={8} />
            </div>
            ...
            {role === "patient" ? (
              ...
              <div className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-2">
                  <Field id="specialization" label="Specialization" placeholder="Cardiology" />
                  <Field id="medicalLicenseNumber" label="Medical license number" placeholder="SCFHS-123456" />
                  <Field id="yearsExperience" label="Years of experience" type="number" min={0} max={70} placeholder="12" />
                  <Field id="consultationFee" label="Consultation fee (SAR)" type="number" min={0} step="1" placeholder="350" />
                </div>
                <div className="space-y-1.5">
                  <Label htmlFor="bio">Short bio</Label>
                  <Textarea id="bio" name="bio" required minLength={20} maxLength={1000} rows={4} placeholder="Tell patients about your practice and experience." />
                </div>
                <div className="space-y-1.5">
